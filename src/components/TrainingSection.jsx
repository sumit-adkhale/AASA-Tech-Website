  ...
  return (
    <>
      <section className="relative text-center mt-20 overflow-hidden z-20 py-12">
        ...
        <div className="xs:text-2xl text-xl relative text-center flex justify-center z-30 font-semibold bg-gradient-to-r from-black to-gray-600  text-transparent bg-clip-text">
      ...
      <section className="py-12 px-6">
        <ColoredText
          ...
          fontSize={"xs:text-3xl text-2xl relative z-50"}
        />
      ...
      <div className="flex justify-center">
        <Button
          customcss={"rounded-xl xs:text-3xl text-xl py-3"}
          data={"Book Now at ₹49"}
        />
      </div>
    </>
